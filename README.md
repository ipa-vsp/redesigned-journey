...
Go to Extensions → search for “License Header Manager”

Open Command Palette (Ctrl+Shift+P) →
License Header Manager: Add License Header

Then add this to your settings.json:

```jason
{
  "licenseHeaderManager.license": {
    "name": "Apache 2.0",
    "author": "Your Name",
    "year": "2026",
    "description": "ROS2 component"
  },
  "licenseHeaderManager.languages": {
    "cpp": {
      "template": [
        "/*",
